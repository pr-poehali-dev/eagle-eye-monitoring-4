    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-[280px] sm:w-[350px]">
        ...
        <nav className="flex flex-col gap-3 mt-8">
          ...
          <a
            href="https://drive.usercontent.google.com/download?id=1OH9t0Su_FqkGZzGWpurL7tceyh4G7XP_&export=download&authuser=0&confirm=t&uuid=bbb3f972-6cff-4062-b013-6be7082a07c0&at=ALBwUgnBYHx-YM94J2J0ppIg5LVL%3A1777309608470"
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => setOpen(false)}
